...
module.exports = {
  dev: {
    ...
    proxyTable: {
      '/api/a': {
        target: 'http://121.248.53.9:9035',   //设置你调用的接口域名和端口号 别忘了加http
      ...
      '/api/b': {
        target: 'http://121.248.53.9:9036',   //设置你调用的接口域名和端口号 别忘了加http
        changeOrigin: true,       //這裡true表示实现跨域
        pathRewrite: {
      ...
      '/api/c': {
        target: 'http://121.248.53.9:9044',   //设置你调用的接口域名和端口号 别忘了加http
        changeOrigin: true,       //這裡true表示实现跨域
        pathRewrite: {
      ...
      '/api/d': {
        target: 'http://121.248.53.9:9032',   //设置你调用的接口域名和端口号 别忘了加http
        changeOrigin: true,       //這裡true表示实现跨域
        pathRewrite: {
